...
public class Thanos {
    ...
    public static void main(String[] args) {
        ...
        Comparator<Hero> comparatorAgeHro = new Comparator<Hero>() {
            @Override
        ...
        Collections.sort(heroes, comparatorAgeHro);

        // or Collections.sort(heroes, Comparator.comparing(Hero::getAge).reversed());
